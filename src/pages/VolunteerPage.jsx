    ...
    <section className="volunteerPage" aria-labelledby="volunteer-heading">
      <div className="pageContent">
        ...
        <p>
          ...
          minutes” dance? Do you find joy in the aroma of wet dog and the
          symphony of happy purrs? You might be the purr-fect fit for our team!
        </p>
        ...
        <ul className="volunteerList">
          ...
          <li className="volunteerListItem">
            <strong>Dog Whisperer & Treat Dispenser Extraordinaire:</strong>{" "}
            Speak fluent “woof” and spot the difference between a playful nip
            and a warning.
          </li>
          <li className="volunteerListItem">
