    ...
    <section className="careersPage" aria-labelledby="careers-heading">
      <div className="pageContent">
        ...
        <ul className="careersList">
          ...
          <li className="careersListItem">
            <strong>Environmental Enrichment Expert:</strong> Provide
            stimulating play, cozy spaces, and plenty of squeaky toys.
          </li>
          <li className="careersListItem">
        ...
        <ul className="careersList">
          ...
          <li className="careersListItem">
            A desire to make a real difference—one wagging tail or contented
            purr at a time.
          </li>
        </ul>
